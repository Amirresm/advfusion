...
OUTPUT_DIR="$PROJECT_ROOT/results/jobs/qwen2.5coder1.5b_ct/adp_r"
mkdir -p "$OUTPUT_DIR"
...
benchmark_dataset_name_or_path="/home/amirreza/projects/ubc/multipl_e_ct/data/processed/ct_bench_dataset_all_r.jsonl"
